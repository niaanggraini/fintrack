<x-app-layout>
    <div class="py-8">
        <div class="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <!-- Header -->
            <div class="mb-6">
                <h2 class="text-2xl font-bold text-gray-900 mt-2 text-center">Edit Pengeluaran</h2>
            </div>
                ...
                <div class="p-6">
                    ...
                    <form action="{{ route('pengeluaran.update', $pengeluaran->id) }}" method="POST">
                        ...
                        <div class="flex justify-end gap-3 pt-4  ">
                            ...
                            class="px-6 py-2.5 rounded-lg font-medium border border-gray-300 text-gray-700 hover:bg-gray-50 transition">
                                Batal
                            </a>
