<x-app-layout>
    <div class="py-8">
        <div class="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <!-- Header -->
            <div class="mb-6">
                <h2 class="text-2xl font-bold text-gray-900 mt-2 text-center"><strong>Tambah Pemasukan</strong></h2>
            </div>
            ...
            <div class="bg-white rounded-lg shadow-sm border border-gray-200">
                <div class="p-6">
                    ...
                    <form action="{{ route('pemasukan.store') }}" method="POST">
                        ...
                        <!-- Jenis Pemasukan -->
                        <div class="mb-5">
                            <label class="block text-sm font-semibold text-gray-700 mb-2">Jenis Pemasukan</label>
                            <input type="text" name="nama" value="{{ old('nama') }}" required
                                placeholder="Contoh: Gaji, Bonus"
                                class="w-full px-4 py-2.5 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#1B365C] focus:border-transparent @error('nama') border-red-500 @enderror">
                            @error('nama')
                        ...
                        <div class="mb-5">
                            ...
                            <input type="number" name="jumlah" value="{{ old('jumlah') }}" required
                                min="0" step="1"
                                class="w-full px-4 py-2.5 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#1B365C] focus:border-transparent @error('jumlah') border-red-500 @enderror">
                            @error('jumlah')
                                <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                            @enderror
                        </div>
